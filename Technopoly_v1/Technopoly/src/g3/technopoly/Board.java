...
public class Board {
	...
	public void populateBoard() {
		...
		for (StartupSpaceValues space : StartupSpaceValues.values()) {
			...
			spaces.add(new StartupSpace(space.getSpaceName(), false, false, space.getPrice(), space.getSite_price(), 0, space.getSpaceField(), space.getSetRequired(), space.getStaff_1_price(), space.getStaff_2_price(), space.getStaff_3_price(), space.getStaff_4_price()));
		}
